    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
        <div>
            <x-ui.image
                ...
                :existingImage="$existing_photo ? route('company-admin.employees.documents.file', $existing_photo) : null"
            />
        </div>
        ...
        <div>
            <x-ui.image
                ...
                accept="image/*"
                hint="{{ tr('JPG/PNG - max 2MB') }}"
                :existingImage="$existing_national_id_photo ? route('company-admin.employees.documents.file', $existing_national_id_photo) : null"
            />
        </div>
        ...
        <div class="md:col-span-2">
            <x-ui.file
                ...
                :existingFile="$existing_qualification ? ['original_name' => $existing_qualification->title ?? basename($existing_qualification->file_path), 'url' => route('company-admin.employees.documents.file', $existing_qualification)] : null"
            />
        </div>
    </div>
...
<div class="mt-4 rounded-xl sm:rounded-2xl border bg-gray-50 p-3 sm:p-4 text-[11px] sm:text-[12px] text-gray-600">
